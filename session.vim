...
nnoremap <silent>  tf :CocCommand metals.revealInTreeView metalsPackages
nnoremap <silent>  tb :CocCommand metals.tvp metalsBuild
nnoremap <silent>  tc :CocCommand metals.tvp metalsCompile
nnoremap <silent>  tp :CocCommand metals.tvp metalsPackages
nnoremap <silent>  t :CocCommand metals.tvp
...
nmap \ws <Plug>(coc-metals-expand-decoration)
...
nmap cs <Plug>Csurround
nnoremap <silent> c	 :let @/=expand('<cword>')cgn
...
nmap <S-F6> :call DisableVimspectorRestartOnWrite()
nmap <S-F5> :call VimspectorMinimalUI()
nmap <F2> :call vimspector#Reset()
...
set laststatus=2
set mouse=a
set operatorfunc=<SNR>25_opfunc
set ruler
set runtimepath=~/.vim,~/.vim/pack/vimspector.old/opt/vimspector,~/.vim/pack/vimspector/opt/vimspector,~/.vim/plugged/vim-surround,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-arduino-syntax,~/.vim/plugged/vim-autoclose,~/.vim/plugged/vim-vue,~/.vim/plugged/vim-pug,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-rooter,~/.vim/plugged/robotframework-vim,~/.vim/plugged/rst-robotframework-syntax-vim,~/.vim/plugged/neomake-platformio,~/.vim/plugged/vim-scala,~/.vim/plugged/aspnetcs,~/.vim/plugged/vimspector,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/robotframework-vim/after,~/.vim/plugged/vim-scala/after,~/.vim/after
set shiftwidth=2
...
set updatetime=300
set wildignore=*.a*.o,*.gif,*.bmp,*.png,*.ico,*.jpg,*/node_modules/*,.git,.hg,.svn,*/target/*,*~,*.swp,*.tmp,*.pyc
set winminheight=0
set winminwidth=0
set nowritebackup
...
silent only
silent tabonly
cd /sdd1/PROJECTS/CODELAB/NODE_HOME/generator-restful-quasar-framework
...
badd +1 package.json
badd +143 generators/crud/index.js
badd +1 /sdd1/PROJECTS/CODELAB/GENERATED/postgres-flask-restful/app.py
badd +191 /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework/src/pages/Pais.vue
badd +1 node_modules/change-case/dist/index.d.ts
badd +126 generators/crud/templates/Page.vue.ejs
badd +1 generators/crud/templates
badd +157 /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework/src/pages/PaisPage.vue
badd +1 /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework/src/router/routes.js
badd +1 generators/crud/templates/Prospectos.vue.ejs
badd +2 generators/crud/templates/json_route_router.ejs
badd +41 session.vim
badd +1 generators/app/index.js
badd +108 generators/app/templates/quasar.config.js
badd +104 /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework/quasar.config.js
argglobal
%argdel
$argadd package.json
set stal=2
...
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit generators/crud/templates/Page.vue.ejs
argglobal
balt generators/crud/index.js
...
silent! normal! zE
let &fdl = &fdl
let s:l = 126 - ((26 * winheight(0) + 53) / 106)
...
normal! 018|
tabnext
edit /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework/src/router/routes.js
...
exe '2resize ' . ((&lines * 52 + 55) / 110)
argglobal
terminal ++curwin ++cols=132 ++rows=53 
let s:term_buf_81 = bufnr()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
keepjumps 44
normal! 022|
lcd /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework
wincmd w
argglobal
balt /sdd1/PROJECTS/CODELAB/GENERATED/restful-quasar-framework/src/pages/PaisPage.vue
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
exe '2resize ' . ((&lines * 52 + 55) / 110)
tabnext
edit /sdd1/PROJECTS/CODELAB/GENERATED/postgres-flask-restful/app.py
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 52 + 55) / 110)
exe '2resize ' . ((&lines * 53 + 55) / 110)
argglobal
terminal ++curwin ++cols=132 ++rows=52 
let s:term_buf_8 = bufnr()
balt /sdd1/PROJECTS/CODELAB/GENERATED/postgres-flask-restful/app.py
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
keepjumps 47
normal! 03|
lcd /sdd1/PROJECTS/CODELAB/GENERATED/postgres-flask-restful
wincmd w
argglobal
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
...
silent! normal! zE
let &fdl = &fdl
let s:l = 211 - ((28 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 211
